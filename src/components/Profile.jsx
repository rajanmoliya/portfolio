    ...
    >
      ...
      <div className="section__text text-center lg:text-center lg:w-1/2 lg:mr-8  ">
        ...
        <div className="btn-container flex justify-center lg:justify-center gap-4 mb-6">
          <button
            className="btn btn-color-2 border border-gray-700 px-6 py-3 rounded-full text-md  transition-all hover:bg-gray-700 hover:text-white"
            onClick={() => window.open("./assets/resume-example.pdf")}
          >
            Download CV
          </button>
          <button
            className="btn btn-color-1 bg-gray-800 text-white px-6 py-3 rounded-full text-md font-thin  transition-all hover:bg-black"
        ...
        >
          <img
            ...
            className="icon w-8 h-8 cursor-pointer hover:scale-110 "
            onClick={() =>
